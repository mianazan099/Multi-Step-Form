  ...
  return (
    <div className="text-sm">
      <div className="mb-1 flex justify-between">
        ...
        <p className={`font-medium text-strawberryRed ${valid && 'hidden'}`}>This field is required</p>
      </div>
      <input
        className={`h-12 w-full text-marineBlue rounded-md border-lightGray focus:ring-purplishBlue focus:border-purplishBlue ${!valid && 'border-strawberryRed focus:ring-strawberryRed focus:border-strawberryRed'}`}
        type={type}
