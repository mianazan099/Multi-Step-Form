...
function Plan({
  ...
  return (
    <div
      className={`flex items-center gap-3.5 rounded-md border p-4 lg:flex-col lg:items-start lg:gap-10 lg:pt-5 ${
        selected
    ...
    <>
      ...
      <div className="flex justify-center gap-6 bg-purplishBlue bg-opacity-5 p-3.5">
        ...
        <label className="relative inline-flex cursor-pointer items-center">
          ...
          <div className="h-5 w-[2.375rem] rounded-full bg-marineBlue after:absolute after:left-[5px] after:top-[4px] lg:after:top-[6px] after:h-3 after:w-3 after:rounded-full  after:bg-white after:transition-all peer-checked:after:translate-x-4 peer-focus:ring-4 peer-focus:ring-pastelBlue"></div>
        </label>
